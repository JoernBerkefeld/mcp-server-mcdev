...
### deploy with --keySuffix and --autoMidSuffix

Use `--keySuffix` and `--autoMidSuffix` / `--no-autoMidSuffix` when you need control over asset keys and MID suffix behavior on deploy. See the **deploy** command documentation for details.
